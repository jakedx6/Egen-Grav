...
/* user.html.twig */
class __TwigTemplate_5220ddb889e7f4bcd6294d6280f4fb3a3df300e050280cea708683cace0cdc36 extends Twig_Template
{
    ...
    public function block_titlebar($context, array $blocks = array())
    {
        ...
        if ( !$this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array())) {
            ...
            // line 13
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ADD_ACCOUNT"), "html", null, true);
            echo "</a>
        </div>
        <h1><i class=\"fa fa-fw fa-users\"></i> ";
            // line 15
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.USERS"), "html", null, true);
            echo "</h1>
    ";
        } else {
            // line 17
        ...
        <h1><i class=\"fa fa-fw fa-user\"></i> ";
            // line 23
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.USER"), "html", null, true);
            echo ": ";
